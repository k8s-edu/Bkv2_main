...
_This is a Helm chart, modified for educational purposes_ from [fluent-bit](https://github.com/fluent/helm-charts/tree/main/charts/fluent-bit)

[Fluent Bit](https://fluentbgitit.io) is a fast and lightweight log processor and forwarder or Linux, OSX and BSD family operating systems.
