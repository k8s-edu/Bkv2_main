...
_This is a Helm chart, modified for educational purposes_ from [pyroscope](https://github.com/grafana/pyroscope/tree/main/operations/pyroscope/helm/pyroscope)
